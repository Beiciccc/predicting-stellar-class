...
OUT_DIR = ROOT / "outputs" / "jun04_adaptive"
TARGET = "class"

BASE = ROOT / "outputs/public_blends/qso_strict3_lr_flex_nina_lgbm_ours.csv"
ANCHOR = ROOT / "outputs/jun04_public_patches/fachri_nina_deep_flex_unanimous_patch.csv"
CANDIDATES = {
    "fachri_flex_nina": ROOT / "outputs/jun04_public_patches/fachri_flex_nina_unanimous_patch.csv",
    "fachri_nina_deep_lgbm": ROOT / "outputs/jun04_public_patches/fachri_nina_deep_lgbm_unanimous_patch.csv",
...
def main() -> None:
    ...
    for name, path in CANDIDATES.items():
        ...
        out_path = OUT_DIR / f"s36_plus_{name}.csv"
